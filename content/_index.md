    ...
    content:
      ...
      text: |-
        ...
        <div class="home-overview-image">
          <iframe class="home-overview-live" src="/slides/?v=20260817&embed#17" title="Research vision — the human ⇄ LLM closed loop (live slide)" loading="lazy" tabindex="-1" aria-hidden="true" scrolling="no"></iframe>
        </div>
